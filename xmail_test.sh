...
# Testversion ohne Mailfunktion, kann aus Shellfenster aufgerufen werden. In DavidX muss
# ein Patient geöffnet sein (wg. Übergabedatei patienten$termin.txt)
...
file=/home/david/trpword/mr/patientenmr.txt
####################
####################
